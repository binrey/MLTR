...
class PredictionVisualizer:
    ...
    def save_buy_and_hold_comparison_plot(
        ...
        self._style_profit_axis(ax_profit, "Strategy vs Buy-and-Hold Cumulative Profit")
    ...
    def save_gradient_change_plot(
        ...
        fig, ax1 = plt.subplots(figsize=(14, 5))
        self._plot_series(ax1, epochs, grad_norm_values, label="grad_norm_l2", color="tab:purple")
        ax1.set_xlabel("Epoch")
