...
FIXTURE_PATH = REPO_ROOT / "tests" / "integration" / "fixtures" / "volprof_ground_truth.json"
COMMITTED_DATE_START = "2025-01-01T00:00:00"
COMMITTED_DATE_END = "2026-01-01T00:00:00"
COMMITTED_FINDATA = str(REPO_ROOT / "fin_data")
CONFIG_PATHS = {
    "BTCUSDT": REPO_ROOT / "configs" / "volprof" / "BTCUSDT.py",
    "ETHUSDT": REPO_ROOT / "configs" / "volprof" / "ETHUSDT.py",
}
...
class TestVolprofGroundTruth(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
