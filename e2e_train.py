...
class E2ETrain:
    ...
    def init_model(self):
        ...
        self.model = E2EModel(inp_shape, 2)
    ...
    def train(self, num_epochs, resume=False, device="cpu", val_size=0.2, run_name="default"):
        ...
        for epoch in pbar:
            optimizer.zero_grad()
            loss = autoregress_sequense(
                self.model, p_train, features_train, device=device)
            loss -= hold_train
            loss.backward()
            optimizer.step()
